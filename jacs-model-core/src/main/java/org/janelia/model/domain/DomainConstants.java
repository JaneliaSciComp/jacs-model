...
public class DomainConstants {
    ...
    public static final String PREFERENCE_CATEGORY_MOUSELIGHT_COLORMODEL = "Mouselight_ColorModel";
    public static final String PREFERENCE_CATEGORY_MOUSELIGHT_UNMIX = "Mouselight_UnMix";
