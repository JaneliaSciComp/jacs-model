 ...
 */
public class OntologyMongoDao extends AbstractPermissionAwareDomainMongoDao<Ontology> implements OntologyDao {

    @Inject
    OntologyMongoDao(MongoDatabase mongoDatabase, ObjectMapper objectMapper) {
        super(mongoDatabase, objectMapper);
    }

    @Override
    public List<Ontology> getAllOntologiesByOwnerKey(String subjectKey, long offset, int length) {
